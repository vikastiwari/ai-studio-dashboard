        ...
        <div style={{ padding: '2rem 2rem 0 2rem', flexShrink: 0 }}>
          <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
            <div>
              ...
              <p style={{ color: 'var(--text-muted)' }}>Monitoring autonomous generation pipelines across 10 niches</p>
            </div>
            <div style={{ display: 'flex', gap: '1rem' }}>
              ...
              >
                ...
                {activeState.isRunning ? 'Pipeline Active...' : 'Render Active Channel'}
              </button>
            </div>
          </header>

          <div className="tabs-container">
            {['overview', 'traces', 'analytics', 'finops', 'logs', 'settings'].map(tab => (
              <button 
                key={tab}
              ...
              >
                {tab === 'finops' ? 'FinOps' : tab.charAt(0).toUpperCase() + tab.slice(1)}
